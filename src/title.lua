...
local textTicker = {
    ...
    "\x02\x05" .. "Cursor Keys/PAD = Left & Right   " .. "\x02\x06" .. "Space/A Button = Jump   " .. "\x02\x03" .. "Pause/Tab/X Button = Pause      " .. "\x02\x04" .. "Alt/Y Button = Tune On/Off     " .. "\x02\x05" .. "S/B Button = High Scores" .. TEXT_32 ..
